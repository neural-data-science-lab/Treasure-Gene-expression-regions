...
\ohead{Gene Expression Patterns in Mouse Brains and their link to Connectivities}
%\ohead{Linking Connectivities and Gene Expression Patterns in the Mouse Brain}
\cfoot*{\pagemark}
%opening
\title{Gene Expression Patterns in Mouse Brains and their link to Connectivities}
...
\title{ \normalsize \textsc{Diploma thesis}
	\\ [2.0cm]
	\HRule{0.5pt} \\
	\LARGE \textbf{\uppercase{Gene Expression Patterns in Mouse Brains and their link to Connectivities}
		\HRule{1pt} \\ [0.5cm]
...
\end{equation}
\todo{What is EmbVar exactly? Give good intuition here! Note that EmbVar may reach values above 1}
...
\begin{itemize}
	\item results on the images? \todo{Include GCN-based images}
\end{itemize}
